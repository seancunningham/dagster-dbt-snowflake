        ...
        create or replace transient table _dev_analytics.int_marketing__astaus.int_attributions_last_click_30d_same_brand
         as
        (with
    attribution as (
    ...
    products as (
            select * from _dev_analytics.inventory_db__astaus.products
        ),
