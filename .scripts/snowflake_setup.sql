...
------ SNAPS
CREATE DATABASE IF NOT EXISTS SNAPS;

GRANT USAGE ON DATABASE SNAPS TO DATA_ENGINEER;
GRANT USAGE ON ALL SCHEMAS IN DATABASE SNAPS TO DATA_ENGINEER;
GRANT USAGE ON FUTURE SCHEMAS IN DATABASE SNAPS TO DATA_ENGINEER;
GRANT SELECT ON ALL TABLES IN DATABASE SNAPS TO DATA_ENGINEER;
GRANT SELECT ON FUTURE TABLES IN DATABASE SNAPS TO DATA_ENGINEER;
GRANT CREATE SCHEMA ON DATABASE SNAPS TO ROLE SERVICE_PRINCIPLE;
...
------ _DEV_SNAPS
CREATE DATABASE IF NOT EXISTS _DEV_SNAPS;
GRANT USAGE ON DATABASE _DEV_SNAPS TO DATA_ENGINEER;
GRANT CREATE SCHEMA ON DATABASE _DEV_SNAPS TO ROLE DATA_ENGINEER;
