...
CREATE OR REPLACE TRANSIENT DATABASE _DEV_ANALYTICS;
...
CREATE OR REPLACE DATABASE _DEV_SNAPSHOT;
GRANT USAGE ON DATABASE _DEV_SNAPSHOT TO RAW_DEVELOPER;
GRANT CREATE SCHEMA ON DATABASE _DEV_SNAPSHOT TO RAW_DEVELOPER;
